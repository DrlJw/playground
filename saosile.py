...
output_label0 = Label(root,text ="这个是", font =("仿宋", 18,"bold"))
cv.create_window(20, 20, anchor=NW, window= output_label0)
output_label1 = Label(root,text ="表白恶搞程序", font =("仿宋", 18,"bold"))
cv.create_window(30, 60, anchor=NW, window= output_label1)
output_label2 = Label(root,text ="就50行", font =("仿宋", 18,"bold"))
